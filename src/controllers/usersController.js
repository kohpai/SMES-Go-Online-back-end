...
router.route('/redirect').get((req, res, next) => {
    ...
    console.log('https://oauth.gsoftbiz.com'+ req.get('data')+'&access_token='+req.cookies.access_token) //decodeURIComponent(
    // console.log('http://localhost:8080'+ decodeURIComponent(req.param('data'))+'&access_token='+req.cookies.access_token)

    res.redirect('https://oauth.gsoftbiz.com'+ req.get('data') +'&access_token='+req.cookies.access_token) //decodeURIComponent(
